# 🎉 linkedin2md - Easily Convert LinkedIn Data to Markdown
...
- **Python:** Version 3.8 or later must be installed on your machine.
...
## 📊 Features
- **Convert Data Quickly:** Transform LinkedIn exports into Markdown format without hassle.
- **Supports Major Tools:** Seamlessly integrate with NotebookLM, Claude, or ChatGPT for easy interactions.
- **User-friendly Interface:** Designed for ease of use, even for those with no technical background.

## ⚙️ Advanced Options
If you are familiar with command-line tools, you can access additional features:
- **Custom Output Locations:** Specify where to save your Markdown files.
...
### How do I find my LinkedIn data export?
1. Log in to your LinkedIn account.
2. Click on the "Me" icon at the top.
3. Select "Settings & Privacy."
4. Go to the "Data Privacy" tab.
5. Under "Get a copy of your data," select "Download your data."

### Can I run this on Linux?
Yes! **linkedin2md** works on all major operating systems, including Linux.
...
## ✍️ Contributing
We welcome contributions! If you want to contribute to **linkedin2md**, please check our guidelines in the repository for more information.

## 📄 License
This project is licensed under the MIT License. See the [LICENSE](LICENSE) file for more information. 

Thank you for using **linkedin2md**! We hope you enjoy transforming your LinkedIn data.